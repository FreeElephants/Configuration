...
class ConvertConfigCommand extends AbstractCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if (!$configFormatNormalizer->isValidFormat($inputFormat)) {
            throw new RuntimeException("{$inputFormat} not supported, valid values: ".implode(', ', $configFormatNormalizer->getValidFormats()));
        }
        ...
        if (!$configFormatNormalizer->isValidFormat($outputFormat)) {
            throw new RuntimeException("{$outputFormat} not supported, valid values: ".implode(', ', $configFormatNormalizer->getValidFormats()));
        }
